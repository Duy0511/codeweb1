...
var faHeart = document.getElementById('topSong_love');
...
function renderTopSong(){
    ...
    } else {// giu cho cac bai nhac o top song van con nguyen ven khi ma ko mo nhung bai o top song
        listTopSong.innerHTML += `
...
function pushArray(){// cho vao mang array add mot so 4 so bat ki
...
function renderForYou(){
        recentPlayedTitle.textContent = `For You`;
        recentSong.innerHTML = '';
        arrayAdd = [];
        pushArray();
        for ( var i = 0 ; i < arrayAdd.length ; i++){
                recentSong.innerHTML += `
                <div class="recentPlayed_item recentPlayed_item${i}" onclick="playMusicOf(${arrayAdd[i]},${i})">
                        <div class="recentPlayed_item-img1">
                            <img class="recentPlayed_item-img" src="./img/${listSongOf[arrayAdd[i]].img}" alt="">
                        </div>
                        <div class="recentPlayed_item-nameSong">
                        ${listSongOf[arrayAdd[i]].nameSong}-
                        </div>
                        <!-- <div class="recentPlayed_item-artist">
                            SON TUNG
                        </div> --!>
...
function renderLikedSong(){
    recentPlayedTitle.textContent = `Liked Song`;
    recentSong.innerHTML = '';
    arrayAdd = [4,5,6,7,8,10];
    pushArray();
    for ( var i = 0 ; i < arrayAdd.length ; i++){
            recentSong.innerHTML += `
            <div class="recentPlayed_item recentPlayed_item${i}" onclick="playMusicOf(${arrayAdd[i]},${i})">
