  ...
  <html>
    ...
    <body class="body">
      ...
      <?php
        ...
        $user = $_POST["user"];
        $pass = $_POST["pass"];
        if($conn -> query("INSERT INTO signup (fullname,email,username,password) VALUES (N'$fullname',N'$email',N'$user',N'$pass')")){
          $msg = "Add Success";
        }else{
          $msg = "Add Fail";
        }
      ...
      <div class="login-page">
        <div class="form">
          <form method="POST" action="">
            ...
            <input name="user" type="text" placeholder="pick a username" />
            <input name="pass" type="password" id="password" placeholder="set a password" />
